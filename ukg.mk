...
# device
$(call inherit-product-if-exists, device/samsung/l900/full_l900.mk)
...
PRODUCT_MODEL := Samsung Galaxy Note 2
PRODUCT_MANUFACTURER := Samsung
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.l900.$(shell date +%m%d%y).$(shell date +%H%M%S)
...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    PRIVATE_BUILD_DESC="l900-user 4.2.2 JDQ39 573038 release-keys" \
    BUILD_FINGERPRINT="samsung/l900:4.2.2/JDQ39/573038:user/release-keys"
